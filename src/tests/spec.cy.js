...
                .select("ADS040 - Business Intelligence e Data Warehousing")
     cy.get("#inputProva")
                .select("A3")
     cy.get('#inputArgumentacao').type('Teste automatizado utilizando Cypress')
     cy.get('body > div > div > div.card-body > form > button').click()
     cy.get('body > div > div > div.card-body').contains('ADS040 - Business Intelligence e Data Warehousing')
     cy.get('body > div > div > div.card-body').contains('Pendente')

     cy.visit('/requerimentos')
     cy.get('body > div > div > div.card-header > a').click()
     cy.get("#inputDisciplina")
                .select("ADS030 - Manutenção de Software e DevOps")
     cy.get("#inputProva")
                .select("A3")
     cy.get('#inputArgumentacao').type('Teste automatizado utilizando Cypress')
     cy.get('body > div > div > div.card-body > form > button').click()
     cy.get('body > div > div > div.card-body').contains('ADS030 - Manutenção de Software e DevOps')
     cy.get('body > div > div > div.card-body').contains('Pendente')
